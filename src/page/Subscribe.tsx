...
export function Subscribe() {
  ...
  return (
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto sm:flex-col gap-10">
        <div className="max-w-[640px] flex flex-col sm:items-center p-2">
          <Logo />
          <h1 className="mt-8 text-[2.5rem] leading-tinght sm:text-center">
            Construa uma{" "}
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded sm:w-[100%]">
